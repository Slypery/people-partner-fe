...
function ManagemenPenggunaStep2Page() {
    ...
    return (
        <form onSubmit={handleFormSubmit} data-transition-page data-animate="enter" className="gap-4 grid grid-cols-1 @max-6xl/main:grid-cols-1 px-8 py-4 fade-in-up fade-out-up">
            <h1 className="col-span-full font-semibold text-3xl flex gap-2">DAFTAR PENGGUNA DAN HAK AKSES SEMUA DIVISI</h1>
                ...
                <div className="overflow-x-auto">
                    <table className="table">
                        <tr>
                            ...
                            <td className="font-bold">DIVISI</td>
                        </tr>
                        <tr>
                            <td>1.</td>
                            <td>ABC</td>
...
export default ManagemenPenggunaStep2Page;