            ...
            <div className="flex flex-col w-full gap-2">
                <div className="overflow-x-auto w-full">
                    <table className="table table-fixed w-full min-w-[500px]">
                        <tr>
                            <td className="font-bold text-3xl" colSpan={2}>Komponen Gaji</td>
                            <td className="font-bold text-3xl" colSpan={2}>Status Pajak</td>
                            <td className="font-bold text-3xl" colSpan={2}>PTKP</td>
                        </tr>
                        <tr>
